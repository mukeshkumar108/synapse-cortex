...
- id=9a03aa49-74a0-40c2-b383-f9f0702aeec6 type=ExpectationType.USER_INTENTION state=OutcomeState.UNKNOWN title='Mum wants me to call Auntie tomorrow about something to do with the house' summary='User intends: Mum wants me to call Auntie tomorrow about something to do with the house (tomorrow)' src_system=None evidence=None
## COMMITMENTS (0)
...
- +expectations=['9a03aa49-74a0-40c2-b383-f9f0702aeec6'] +loops=[] +commitments=[] +facts=[]
...
- id=9a03aa49-74a0-40c2-b383-f9f0702aeec6 type=ExpectationType.USER_INTENTION state=OutcomeState.UNKNOWN title='Mum wants me to call Auntie tomorrow about something to do with the house' summary='User intends: Mum wants me to call Auntie tomorrow about something to do with the house (tomorrow)' src_system=None evidence=None
- id=95adf1f0-3bbf-4dd7-82b6-f14c634d437b type=ExpectationType.EXTERNAL_DEPENDENCY state=OutcomeState.UNKNOWN title='She said she’ll send me a photo' summary='Expected from another: She said she’ll send me a photo' src_system=None evidence=None
## COMMITMENTS (0)
## PROPOSAL EXPOSURE (stored ASK vs Sophie-noticed shelf)
stored_ask=0
surfaced_shelf:
...
## TURN FRAMES (0): {}
## WHAT CHANGED SINCE LAST CHECKPOINT
- +expectations=['95adf1f0-3bbf-4dd7-82b6-f14c634d437b'] +loops=[] +commitments=[] +facts=[]
